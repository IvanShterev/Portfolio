    ...
    return (
        <>
            <div className="desc-cont">
                ...
                <p>
                    I specialize in turning innovative ideas into practical applications by adeptly simplifying complexity, ultimately crafting outstanding user experiences.
                </p>
